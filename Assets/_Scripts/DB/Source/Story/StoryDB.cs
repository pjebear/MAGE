...
{
    class StoryDB : DBBase<int, DBStoryArcInfo>
    {
        public StoryDB() : base("StoryDB")
        {
        }
        ...
        public override void Save(string path)
        {
            ...
            FileUtil.WriteFile(path, FileUtil.FileName.StoryDB.ToString(), jsonString);
        }
        ...
        public override void Load(string path)
        {
            ...
            string jsonString = FileUtil.ReadFile(path, FileUtil.FileName.StoryDB.ToString());
