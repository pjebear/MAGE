...
{
    class ScenarioDB : DBBase<int, DBScenarioInfo>
    {
        public ScenarioDB() : base("ScenarioDB")
        {
        }
        ...
        public override void Save(string path)
        {
            ...
            FileUtil.WriteFile(path, FileUtil.FileName.ScenarioDB.ToString(), jsonString);
        }
        ...
        public override void Load(string path)
        {
            ...
            string jsonString = FileUtil.ReadFile(path, FileUtil.FileName.ScenarioDB.ToString());
