...
{
    class EncounterDB : DBBase<int, DBEncounterInfo>
    {
        public EncounterDB() : base("EncounterDB")
        {
        }
        ...
        public override void Save(string path)
        {
            ...
            FileUtil.WriteFile(path, FileUtil.FileName.EncounterDB.ToString(), jsonString);
        }
        ...
        public override void Load(string path)
        {
            ...
            string jsonString = FileUtil.ReadFile(path, FileUtil.FileName.EncounterDB.ToString());
