...
namespace MAGE.GameModes.FlowControl
{
        ...
        //Messaging.IMessageHandler
    {
        ...
        //    foreach (Character character in GameModel.Encounter.PendingCharacterTurns)
        //    {
        //        turnOrder.Add(character.Name);
        //    }
        //    dp.TurnOrder = turnOrder;

        //    dp.CurrentTurn = GameModel.Encounter.Clock;

        //    if (GameModel.Encounter.CurrrentTurnCharacter != null)
        //    {
        //        Character currentTurn = GameModel.Encounter.CurrrentTurnCharacter;
        ...
        //    dp.CurrentState = GameModel.Encounter.EncounterState;
