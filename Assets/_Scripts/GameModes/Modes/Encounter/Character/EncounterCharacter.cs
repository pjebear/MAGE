...
namespace MAGE.GameModes.Encounter.Internal
{
    ...
    //    public EncounterCharacter(TeamSide team, MAGE.GameSystems.Characters.CharacterInfo character)
    //    {
    //        Id = character.Id;
    //        Team = team;
    ...
    //    public int GetStackCountForStatus(StatusEffectId statusType, EncounterCharacter statusCreator)
    //    {
    //        int stackCount = 0;
