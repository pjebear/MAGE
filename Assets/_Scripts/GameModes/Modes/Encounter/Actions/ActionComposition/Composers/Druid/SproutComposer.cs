...
{
    class SproutComposer : AOESpellComposerBase
    {
        public SproutComposer(CombatEntity owner) : base(owner)
        {
        }
        ...
        protected override ActionInfo PopulateActionInfo()
        {
            ...
            actionInfo.ActionId = ActionId.Sprout;
            ...
            actionInfo.SummonInfo.SummonType = SummonType.Tree;
            actionInfo.SummonInfo.SummonCount = 6;
        ...
        {
            return new EmptySpaceSolver() { SpaceCount = ActionInfo.SummonInfo.SummonCount };
        }
