...
namespace MAGE.GameModes.Encounter
{
    class EffectActionComposer
    {
        public static void ComposeAction(CharacterActorController ownerController, ActionInfoBase actionInfo, TargetSelection targetSelection, Map map, out ActionResult result, out Timeline<ActionEvent> timeline)
        {
            ...
            List<Character> targets = EncounterFlowControl_Deprecated.MapControl.Map.GetTargetedCharacters(ownerPosition, targetSelection);
            ...
            for (int i = 0; i < targets.Count; ++i)
            {
                ...
                CharacterActorController targetController = null;// EncounterFlowControl_Deprecated.CharacterDirector.CharacterActorLookup[targets[i]];
                ...
                EffectSpawnBlock effectSpawnBlock = new EffectSpawnBlock(actionInfo.EffectInfo.EffectId, actionInfo.EffectInfo.SFXId, targetController.transform);
