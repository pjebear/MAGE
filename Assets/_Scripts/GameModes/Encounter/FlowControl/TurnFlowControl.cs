    ...
    , IEventHandler<EncounterEvent>
{
    ...
    public void ProgressTurn(EncounterCharacter actor)
    {
        ...
        UIManager.Instance.PostContainer(UIContainerId.ActorActionsOverlay, this);
    }
                                ...
                                case (0):
                                    {
                                        ...
                                        UIManager.Instance.Publish(UIContainerId.ActorActionsOverlay);
                                    }
    ...
    private void OnActionSelected()
    {
        ...
        UIManager.Instance.RemoveOverlay(UIContainerId.ActorActionsOverlay);
    }
