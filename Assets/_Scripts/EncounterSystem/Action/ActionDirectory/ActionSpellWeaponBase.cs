...
//    class ActionSpellWeaponBase : ActionBase
//    {
...
//            {
//                if (weapon != null && weapon.ActionIndex == ActionIndex.SPELL_WEAPON)
//                {
...
//                if (Physics.Linecast(start, target, 1 << LayerMask.NameToLayer("Map")))
//                {
